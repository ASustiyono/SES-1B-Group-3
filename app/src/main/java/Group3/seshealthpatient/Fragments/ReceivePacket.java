 ...
 * {@link RecievePacket.OnFragmentInteractionListener} interface
...
public class RecievePacket extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_recieve_packet, container, false);

        textView = getView().findViewById(R.id.messageDisplay);
